...
<!-- mcuadrado <- read.csv(file = '/home/ignacio/datos/facultad/repos/especializacion/data/barrioMetroCuadrado.csv') -->
<!-- #mcuadrado -->
...
<!-- prod_mtx = model.matrix(precio~ banderaDescripcion + sucursalTipo + medicion + cantPtosVenta + mCuadradoC, data = precios_train) -->
