##### El siguiente proyecto se corresponde al Trabajo Final Especialización en Explotación de Datos y Descubrimiento de Conocimiento (Data Mining \& Knowledge Discovery) de la Universidad de Buenos Aires.
